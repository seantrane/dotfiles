...
defaults write NSGlobalDomain AppleHighlightColor \
  -string "0.968627 0.831373 1.000000 Purple"

# Set sidebar icon size to medium
# defaults write NSGlobalDomain NSTableViewDefaultSizeMode -int 2

# Scroller Paging Behavior
...
# Fix 'Fetching...' issue in macOS 'Open With' and 'Share' context menus
...
# defaults -currentHost write NSGlobalDomain \
#   com.apple.trackpad.enableSecondaryClick -bool false
...
# Show folders sorted at top, separate from files
...
# defaults write NSGlobalDomain NSToolbarTitleViewRolloverDelay -float 0.7
...
/usr/libexec/PlistBuddy -c \
  ...
  ~/Library/Preferences/com.apple.finder.plist
/usr/libexec/PlistBuddy -c \
  "Set :FK_StandardViewSettings:IconViewSettings:iconSize 36" \
  ~/Library/Preferences/com.apple.finder.plist
/usr/libexec/PlistBuddy -c \
  "Set :StandardViewSettings:IconViewSettings:iconSize 36" \
  ~/Library/Preferences/com.apple.finder.plist
...
# Disable Dashboard (DEPRECATED)
# defaults write com.apple.dashboard mcx-disabled -bool true

# Don't show Dashboard as a Space (DEPRECATED)
# defaults write com.apple.dock dashboard-in-overlay -bool true

# Don't automatically rearrange Spaces based on most recent use
defaults write com.apple.dock mru-spaces -bool false

# Quick auto-hiding Dock delay
defaults write com.apple.dock autohide-delay -float 0.15
# Quick animation when hiding/showing the Dock
...
# find "${HOME}/Library/Application Support/Dock" \
#   -name "*-*.db" -maxdepth 1 -delete
...
# Orientation - where on screen to show the Dock
# options are: right, bottom, left
...
# Set primary app icons in the Dock
defaults write com.apple.dock persistent-apps -array-add "<dict>\
  <key>tile-data</key>\
  <dict>\
    <key>bundle-identifier</key>  <string>com.apple.launchpad.launcher</string>\
    <key>dock-extra</key>         <false/>\
    <key>file-data</key>\
    <dict>\
    ...
    <key>file-label</key>         <string>Launchpad</string>\
...
defaults write com.apple.dock persistent-apps -array-add "<dict>\
  <key>tile-data</key>\
  <dict>\
    <key>bundle-identifier</key>  <string>com.apple.systempreferences</string>\
    <key>dock-extra</key>         <true/>\
    <key>file-data</key>\
    <dict>\
      <key>_CFURLString</key>\
...
defaults write com.apple.dock persistent-apps -array-add "<dict>\
  ...
  <dict>\
    ...
    <key>file-label</key>         <string>Safari</string>\
    <key>file-type</key>          <integer>41</integer>\
    <key>is-beta</key>            <false/>\
  </dict>\
  <key>tile-type</key>            <string>file-tile</string>\
...
# Add 'Applications' list folder to Dock
defaults write com.apple.dock persistent-others -array-add "<dict>\
  ...
  <dict>\
    ...
    <key>file-label</key>         <string>Applications</string>\
...
# Add 'Downloads' list folder to Dock
defaults write com.apple.dock persistent-others -array-add "<dict>\
  <key>tile-data</key>\
  <dict>\
...
# Add 'HOME' list folder to Dock
defaults write com.apple.dock persistent-others -array-add "<dict>\
  <key>tile-data</key>\
  <dict>\
    <key>arrangement</key>        <integer>3</integer>\
    <key>displayas</key>          <integer>1</integer>\
    <key>file-data</key>\
    <dict>\
      <key>_CFURLString</key>     <string>file://$HOME/</string>\
      <key>_CFURLStringType</key> <integer>15</integer>\
    </dict>\
    <key>file-label</key>         <string>$USER</string>\
    <key>file-type</key>          <integer>2</integer>\
    <key>is-beta</key>            <false/>\
    <key>preferreditemsize</key>  <integer>-1</integer>\
    <key>showas</key>             <integer>3</integer>\
...
# Restore Session (Tabs) At Launch
defaults write com.apple.Safari AlwaysRestoreSessionAtLaunch -bool true
defaults write com.apple.Safari \
  ExcludePrivateWindowWhenRestoringSessionAtLaunch -bool true

# Set search provider to 'DuckDuckGo'
...
# defaults write com.google.Chrome ExtensionInstallSources \
#   -array "https://gist.githubusercontent.com/" "http://userscripts.org/*"
...
# defaults write com.apple.menuextra.clock DateFormat -string "E d MMM HH:mm"
