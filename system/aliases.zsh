...
alias update='(cd; sudo softwareupdate -i -a; brew update; brew upgrade; brew cleanup; brew cask cleanup; npm cache clean -g -f; npm install -g npm@latest; npm update -g; npm cache clean -g -f; sudo gem update --system; sudo gem update)'
